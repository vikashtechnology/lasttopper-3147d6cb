    ...
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <section className="prose prose-slate mt-8 max-w-none space-y-6 text-sm leading-6 text-foreground">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            <strong>Learning data:</strong> chapters selected, quiz sessions, answers, timing,
            scores, streaks, and mistakes.
          </li>
          <li>
            <strong>Community content:</strong> posts, doubts, replies, group messages, uploaded
            images, votes, and reports.
          </li>
          <li>
            <strong>Wallet data:</strong> mock in-app balance, transactions, and withdrawal details
            (UPI ID or bank details you submit).
          </li>
          <li>
            <strong>Device/usage:</strong> basic technical logs required to operate the Service.
          </li>
        </ul>
        ...
        <p>
          Quiz questions are generated using AI models restricted to NCERT Class 11 & 12 content.
          Your chapter selections and profession are sent to the AI provider to produce questions.
          We do not send your name, email, or contact details.
        </p>
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            Our admin team via internal messaging channels for operational alerts (e.g., withdrawal
            requests).
          </li>
        ...
        <p>
          Profiles, forum posts, doubts, replies, and leaderboard entries are visible to other
          signed-in users. Do not post personal or sensitive information publicly.
        </p>

        <h2 className="text-lg font-semibold">6. Data retention</h2>
        <p>
          We retain account and learning data while your account is active. Generated question
          caches expire after 24 hours. You may request deletion of your account by contacting
          support.
        </p>

        <h2 className="text-lg font-semibold">7. Security</h2>
        <p>
          We use industry-standard authentication, row-level security, and encrypted connections. No
          system is 100% secure; please use a strong Google account.
        </p>

        <h2 className="text-lg font-semibold">8. Children</h2>
        <p>
          The Service is intended for students preparing for JEE/NEET. Users under 13 must use the
          app under a parent or guardian's supervision.
        </p>
