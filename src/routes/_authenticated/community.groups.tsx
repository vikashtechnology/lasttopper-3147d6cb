...
function GroupsList() {
  ...
  const create = useMutation({
    mutationFn: () =>
      createStudyGroup({ data: { name, description: description || undefined, is_private: priv } }),
    onSuccess: () => {
          ...
          <DialogContent>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="priv" className="text-sm">
                  Private (invite only)
                </Label>
        ...
        {groups.data?.map((g) => (
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              {!g.is_private && (
                <Button size="sm" onClick={() => join.mutate(g.id)} disabled={join.isPending}>
                  Join
                </Button>
              )}
            </div>
