...
2) APP HELP: Explain how to use Last Topper features — Learning (chapter picker + AI quiz), Mistake bank, Mastery analytics, History, Battle arena, Sunday Mega Tests unlocked by completing every fresh admin-assigned task, Community (forums, doubts, groups), Notifications, Profile, and one-time Pro passes (>20 questions/day requires Pro). Competition uses score, rank, XP, streaks, and recognition. The Sunday Mega Test has one prize only: final rank #1 gets a 7-day Pro extension. Mega Test access tasks establish eligibility for one specific test and are not reusable.
